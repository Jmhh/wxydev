                    ...
                    <div class="loginform" v-if="show">
                        ...
                        <form>
                            <div class="form-group">
                                <div class="form-group-input">
                                    ...
                                    <span class="errorInfo" v-show="validate.errorsName">
                                        <i class="iconfont icon-cuowu"></i> {{Errors.userErrors}}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-group-input">
                                    ...
                                    <span class="errorInfo" v-show="validate.errorsPassword">
                                        <i class="iconfont icon-cuowu"></i> {{Errors.passwordErrors}}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="form-group code">
                                <div class="form-code">
                                    ...
                                    <span class="errorInfo" v-show="validate.errorsCode">
                                        <i class="iconfont icon-cuowu"></i> {{Errors.captchaErrors}}
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="login" @click.prevent="login">{{loginStatus}}</button>

                                <button type="button" class="registered" @click.prevent="changeForm">申请开通</button>
...
export default {
    ...
    data() {
        return {
            ...
            Errors: {
                userErrors: "用户名不能为空而且用户名在4到16位之间",
                passwordErrors: "密码不能为空",
                captchaErrors: "验证码长度必须为4"
            },
            loginStatus: "登录"
        };
    },
